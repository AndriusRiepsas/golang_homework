...
func (c *fileUploadClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (FileUpload_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileUpload_ServiceDesc.Streams[0], "/pb.FileUpload/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *fileUploadUploadFileClient) CloseAndRecv() (*UploadResponse, error) {
...
func (x *fileUploadUploadFileServer) SendAndClose(m *UploadResponse) error {
